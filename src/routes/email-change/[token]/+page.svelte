...
<div class="flex min-h-[80vh] items-center justify-center p-4">
	<div class="w-full max-w-md rounded-lg border bg-card p-8 text-card-foreground shadow-sm">
		<h3 class="mb-2">Confirm Email Change</h3>
		<p class="mb-6 text-sm text-muted-foreground">
			Enter your password to complete the email address change.
		</p>

		<form method="POST" use:enhance class="space-y-4">
			<div class="flex flex-col gap-1.5">
				<label for="password" class="text-sm font-medium">Your Password</label>
